...
function CreateForumPage() {
  ...
  const handleClick = async (e) => {
    ...
    await axios
      .post("http://35.78.193.13:9090/forums/new", data, {
        headers: {
      ...
      <div className="w-screen h-screen overflow-x-hidden">
        ...
        <div className=" mt-40 w-10/12 md:w-8/12 mx-auto flex flex-col gap-4 ">
          ...
          <div className="my-10 flex flex-col gap-6 ">
            <InputJudul setInputJudul={setInputJudul} label="Judul Pertanyaan" placeholder="Masukkan judul pertanyaan" />
            <InputTags tag={inputTag} setTags={setInputTag} />
            <InputMarkdown deskripsi="Deskripsi" setEditorState={setInputMarkdown} mode="wysiwyg" placeholder="Tulis deskripsi anda disini" type="createForum" />
