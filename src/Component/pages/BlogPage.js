...
function BlogPage() {
  ...
  useEffect(() => {
    fetchBlogs("http://35.78.193.13:9090/blogs", key);
  }, [fetchBlogs, key]);
  return (
    <>
      <div className="w-screen h-screen overflow-x-hidden">
        ...
        <div className=" mt-40 w-10/12 md:w-8/12 mx-auto flex flex-col gap-4">
          <Head titleHead="Code BlogIn" contentHead="Tempat para programmer menulis seputar wawasan dunia teknologi dan komputer" nameButton="Buat Blog" path="/blog/createblog" setFilter={setFilter} />
