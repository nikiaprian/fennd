...
function DetailForumPage() {
  ...
  useEffect(() => {
    fetchForumId(`http://35.93.77.214:9090/forums/${idforum}`, key);
        ...
        <div className="w-screen h-screen overflow-x-hidden">
          ...
          <div className=" mt-40 w-10/12 md:w-8/12 mx-auto flex flex-col gap-4 ">
            ...
            <div className="my-10 flex flex-col gap-6 ">
              ...
              <div className="border-2 overflow-x-auto bg-[#f2f2f2] border-gray-300 p-4 font-poppins rounded-md shadow-lg" dangerouslySetInnerHTML={{ __html: forum?.content }}></div>
              <ViewAnswers deskripsi="Jawaban" />
              {key && key ? (
                <div>
                  <InputMarkdown deskripsi="Tulis Komentar Di sini" mode="markdown" placeholder="Tulis Komentar anda disini" setEditorState={setInputMarkdown} type="answer" />
